...
\captionof{figure}{Exclusion limits in neutralino mass~(or $\Lambda$) against mean lifetime in SPS8 benchmark GMSB model. Limits from previous experiments are also shown.}
