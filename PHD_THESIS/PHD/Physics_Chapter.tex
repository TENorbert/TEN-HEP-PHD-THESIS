...
\hline \hline
\end{tabular}
\captionof{table}{Super multiplets and particle spin in Supersymmetry.}
\label{tab:SUSYM} 
\end{center}
...
\hline \hline
\end{tabular}
\captionof{table}{Super multiplets and components in Supersymmetry.}
\label{tab:SUSYF} 
\end{center}
...
\hline \hline
\end{tabular}
\captionof{table}{Particles and their representation in Minimal Supersymmetric SM~(MSSM).}
\label{tab:SUSYP} 
\end{center}
...
A common assumption in GMSB models~\cite{GMSB}is that $\lambda_{q} \simeq \lambda_{\ell} \simeq \lambda $ and so $\mathbf{M}_{\mbox{mess}} = \lambda \left\langle \mathrm{S} \right\rangle$. However, in  Pure gauge mediated SUSY breaking models~(PGGM), $\lambda_{q} \neq \lambda_{\ell}$ \cite{PGGM}.
