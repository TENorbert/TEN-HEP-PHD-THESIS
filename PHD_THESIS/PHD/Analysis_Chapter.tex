...
\item using the background template, we obtain a scale factor $$\displaystyle{\mbox{Scale Factor} = \frac{N}{M_{1} + M_{2}}}$$~(see bottom plot of \ref{fig:collZ}) which is use to determine the correct contribution of the background events to the the signal event sample.
