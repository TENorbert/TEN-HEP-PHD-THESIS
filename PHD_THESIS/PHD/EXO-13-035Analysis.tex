...
\vspace{-0.1cm}
  \begin{columns}
    ...
    \mbox{ 
       \includegraphics[height=0.25\linewidth,width=0.45\linewidth]{THESISPLOTS/New-Physics-PLOTS/DMRotationcurve.jpg}          
\includegraphics[height=0.25\linewidth,width=0.45\linewidth]{THESISPLOTS/New-Physics-PLOTS/DM-Rotation-Curves.png} 
          }\\
     \mbox{            
\includegraphics[height=0.25\linewidth,width=0.45\linewidth]{THESISPLOTS/New-Physics-PLOTS/7Years_WMAP_CMB.png} \\
 \includegraphics[height=0.25\linewidth,width=0.45\linewidth]{THESISPLOTS/New-Physics-PLOTS/CMB_Multiple_Moments.png} 
 }
 \mbox{\includegraphics[height=0.25\linewidth,width=0.45\linewidth]{THESISPLOTS/New-Physics-PLOTS/UniversePie30.jpg}
