...
\begin{frame}
\frametitle{New Physics: Observation?}
 \textbf{Why still expect New Physics?}
\begin{minipage}[t]{0.8\paperwidth}
\mbox{
\includegraphics[height=0.20\textwidth,width=0.15\paperwidth]{THESISPLOTS/New-Physics-PLOTS/neutrino-Mass.png} \quad
\includegraphics[height=0.20\textwidth,width=0.25\paperwidth]{THESISPLOTS/New-Physics-PLOTS/VanAlbada-Dark-Matter-Rot-Curves.jpg} \quad
\includegraphics[height=0.20\textwidth,width=0.15\paperwidth]{THESISPLOTS/New-Physics-PLOTS/X-ray-Signature-DM-2014.png} \quad
\includegraphics[height=0.20\textwidth,width=0.15\paperwidth]{THESISPLOTS/New-Physics-PLOTS/SigmaR_v5.pdf}
}
\end{minipage}
...
\vspace{-0.75cm}
  \begin{varblock}[7.2cm]{\textbf{Assume similar distribution in earlier and in-time, in-time and delayed ECAL time for collision events.}}
   \begin{columns}
     ...
     \centering{
      $\frac{Q}{D^{\prime}} = \frac{F}{F^{\prime}}, \Rightarrow $
      }
      \begin{tcolorbox}[colback=blue!5,colframe=UMN@Gold!40]
      \begin{equation*}
