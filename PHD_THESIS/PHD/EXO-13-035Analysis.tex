...
\title{Search For Long-Lived Neutral Particles in Final States with Delayed Photon and Missing Transverse Energy from $pp$ Collisions at $\sqrt{S} = 8$~TeV}
\subtitle{PhD Oral Exam}
%\vspace{-5cm}
\author[Norbert Tambe Ebai]{Norbert Tambe Ebai \\ University Of Minnesota} % (optional, for multiple authors)
