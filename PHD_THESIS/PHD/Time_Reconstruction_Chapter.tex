...
\vspace{-5cm}
\captionof{figure}{Distribution of mean time~($\mu$)[\textit{top row}] and time resolution[ \textit{bottom row}] as a function of crystal energy for EB prior~(left) and after~(right) time bias corrections depending on energy have been applied.}
\label{fig:TimeBias}
\end{center}
\end{minipage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
