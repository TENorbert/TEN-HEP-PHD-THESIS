...
The coordinate system $(\eta, \phi)$, and its radial distance $R$, identifies a point in the cylindrical volume of the CMS detector. We describe in the next subsections the CMS subdetectors used in this thesis.
%\clearpage
\begin{center}
\centering
