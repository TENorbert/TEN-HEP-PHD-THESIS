...
The Large Hadron Collider~(LHC) is a particle accelerator at CERN, accelerating two beams of either protons or ions, through a circular ring, in opposite directions and eventually colliding the beams at a collision point. The Compact Muon Solenoid~(CMS) is a general purpose multiparticle detector located at one of these collision points. A detailed description of the LHC and CMS detector is found in \cite{LHC} and \cite{CMSTDR}, respectively.
